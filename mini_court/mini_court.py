...
class MiniCourt():
    ...
    def set_court_drawing_keypoints(self):
        ...
        # # #point 9
        drawing_key_points[18] = drawing_key_points[16] + self.convert_meters_to_pixels(constants.SIGNLE_LINE_WIDTH)
        drawing_key_points[19] = drawing_key_points[17] 
        # #point 10
        drawing_key_points[20] = drawing_key_points[10] 
        drawing_key_points[21] = drawing_key_points[11] - self.convert_meters_to_pixels(constants.NO_MANS_LAND_HEIGHT)
        # # #point 11
        drawing_key_points[22] = drawing_key_points[20] +  self.convert_meters_to_pixels(constants.SIGNLE_LINE_WIDTH)
    ...
    def draw_court(self, frame):
        ...
        for line in self.lines:
            ...
            cv2.line(frame, start_point, end_point, (0,0,0,0), 2)
        ...
        cv2.line(frame, net_start_point, net_end_point, (255,0,0,0), 2)
        return frame
    ...
    def get_mini_court_coordinates(self,
        ...
        distance_from_keypoints_x_pixels, distance_from_keypoints_y_pixels = measure_xy_distance(object_position, closest_key_point)

        distance_from_keypoints_x_meters = convert_pixel_distance_to_meters(distance_from_keypoints_x_pixels,
                                                                            player_height_in_meters,
                                                                            player_height_in_pixels)
        distance_from_keypoints_y_meters = convert_pixel_distance_to_meters(distance_from_keypoints_y_pixels,
                                                                            player_height_in_meters,
                                                                            player_height_in_pixels)
        ...
        closest_mini_court_keypoints = (
                                        self.drawing_keypoints[closest_key_point_index*2],
                                        self.drawing_keypoints[closest_key_point_index*2]+1,
                                        )
        mini_court_player_position = (closest_mini_court_keypoints[0] + mini_court_x_distance_pixels,
                                        closest_mini_court_keypoints[1] + mini_court_y_distance_pixels)
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                closest_key_point_index = get_closest_keypoints_index(foot_position, original_court_key_points, [0,2,12,13])
                ...
                min_court_player_position = self.get_mini_court_coordinates(foot_position,
                                                                            closest_key_point,
                                                                            closest_key_point_index,
                                                                            max_player_height_in_pixels,
                                                                            player_heights[player_id])

                output_player_bbox_dict[player_id] = min_court_player_position

                if closest_player_id_to_ball == player_id:
                    closest_key_point_index = get_closest_keypoints_index(ball_position, original_court_key_points, [0,2,12,13])
                    closest_key_point = (original_court_key_points[closest_key_point_index*2], original_court_key_points[closest_key_point_index*2+1])

                    min_court_player_position = self.get_mini_court_coordinates(ball_position,
                                                                            closest_key_point,
                                                                            closest_key_point_index,
                                                                            max_player_height_in_pixels,
                                                                            player_heights[player_id])
